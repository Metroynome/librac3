...
#ifndef _LIBRAC3_PAD_H
#define _LIBRAC3_PAD_H
 ...
 * AUTHOR :			
 */
__LIBRAC3_GETTER__ int padGetButton(int port, u16 buttonMask);
 ...
 * AUTHOR :			
 */
__LIBRAC3_GETTER__ int padGetButtonDown(int port, u16 buttonMask);
 ...
 * AUTHOR :			
 */
__LIBRAC3_GETTER__ int padGetButtonUp(int port, u16 buttonMask);
 ...
 * AUTHOR :			
 */
__LIBRAC3_SETTER__ void padResetInput(int port);

#endif // _LIBRAC3_PAD_H